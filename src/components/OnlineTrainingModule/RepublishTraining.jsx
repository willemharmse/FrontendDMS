...
const RepublishTraining = ({ closeModal, retakeInduction, normalPublish }) => {
    return (
        <div className="delete-popup-overlay">
            <div className="delete-popup-content">
                ...
                <div className="delete-file-group">
                    <div className="delete-file-text" style={{ marginBottom: "0px" }}>{"Will these changes require all students to complete the course again?"}</div>
                </div>
...
export default RepublishTraining;