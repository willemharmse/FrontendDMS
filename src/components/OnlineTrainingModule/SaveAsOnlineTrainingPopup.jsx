...
const SaveAsOnlineTrainingPopup = ({ onClose, saveAs, current, type, userID, create, standard = false, special = false }) => {
    ...
    useEffect(() => {
        ...
        async function loadDrafts() {
            let route;
            route = `onlineTrainingCourses/getDrafts/${userID}`
            try {
...
export default SaveAsOnlineTrainingPopup;
