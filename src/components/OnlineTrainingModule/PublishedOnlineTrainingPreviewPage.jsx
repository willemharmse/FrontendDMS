...
const PublishedOnlineTrainingPreviewPage = ({ draftID, closeModal }) => {
    ...
    */
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                setLoading(true);
                console.log("📡 Fetching published induction preview data...", draftID);
                const base = process.env.REACT_APP_URL || "";
                const res = await fetch(`${process.env.REACT_APP_URL}/api/onlineTrainingCourses/getCourseDataPreviewPublished/${draftID}`, {
                    headers: {
                                                        ...
                                                        <div className="inductionView-slide-content">
                                                            ...
                                                            {(currentSlide.type === SLIDE_TYPES.TEXT_MEDIA_2X2) && (
                                                                <div className={`limitHeightInductionView`} style={{ display: "grid", gridTemplateColumns: "2fr 2fr", gap: 16 }}>
                                                                    <div className="inductionView-text-box inductionView-split-text-panel" style={{ whiteSpace: "pre-wrap", fontSize: 22, lineHeight: 1.45, textAlign: "left" }}>
                                                                        <div style={{ margin: "auto 0" }}>
...
export default PublishedOnlineTrainingPreviewPage;