...
const FutureEnhancementPageEPAC = () => {
            ...
            >
                <div className="future-enhancement-page-epac-section-2-block-main">
                    <div className='fi-card'>
                        <img
                            src={`${process.env.PUBLIC_URL}/EPAM.png`}
                            alt="Training Management System (TMS)"
                            className="future-enhancement-page-epac-section-2-block-image-2"
                        />
                    </div>
...
export default FutureEnhancementPageEPAC;
