...
import { faScaleBalanced, faCertificate, faListOl, faChevronLeft, faChevronRight, faArrowLeft, faCaretLeft, faCaretRight, faCircle, faFileAlt, faBars, faCreditCard } from '@fortawesome/free-solid-svg-icons';
import { canIn, getCurrentUser } from "../../utils/auth";
import TopBarDD from "../Notifications/TopBarDD";

const FTSCreateHomePage = () => {
        ...
        <div className="dc-info-container">
            {isSidebarVisible && (
                <div className="sidebar-um">
                    ...
                    <div className="sidebar-logo-dm-fi">
                        <FontAwesomeIcon icon={faCircle} style={{ color: "White" }} src={"/ibra2.svg"} className="icon-risk-rm" />
                        <p className="logo-text-dm-fi">{"Develop Template"}</p>
                    </div>
                </div>
            )}
            ...
            <div className="main-box-dc">
                ...
                <div className="scrollable-box-dc-home">
                    ...
                    <div className={`document-card-dc-home`} onClick={() => navigate("/FrontendDMS/ftsDrafts/template")}>
                        <>
                    ...
                    <div className={`document-card-dc-home`} onClick={() => navigate("/FrontendDMS/ftsGeneratedTemplates")}>
                        <>
                            <div className="icon-dc">
...
export default FTSCreateHomePage;