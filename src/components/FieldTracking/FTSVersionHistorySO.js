...
const FTSVersionHistorySO = () => {
    ...
    const fetchActivity = async () => {
        const route = `/api/ftsGeneratedDocs/signedOffTemplates/getFile/${id}`;
        try {
            ...
            <div className="main-box-dc-version-history-file">
                ...
                <div className="table-flameproof-card">
                    ...
                    <div className="table-containerdc-version-history-file-info">
                        <table style={{ overflowY: "scroll" }} className="dc-version-history-file-info-table">
...
export default FTSVersionHistorySO;