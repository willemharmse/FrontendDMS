...
const FTSDeletedTemplatesSO = () => {
    ...
    const deleteFile = async () => {//*NB
        ...
        try {
            setLoading(true);
            const response = await fetch(`${process.env.REACT_APP_URL}/api/ftsGeneratedDocs/signedOffTemplates/deleteFile/${fileToDelete}`, {
    ...
    const restoreFile = async (fileId) => {//*NB
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/ftsGeneratedDocs/signedOffTemplates/restoreFile/${fileId}`, {
                method: 'POST',
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const fetchFiles = async () => {
        const route = `/api/ftsGeneratedDocs/signedOffTemplates/trash/getFiles`;
        try {
        ...
        <div className="gen-file-info-container">
            ...
            <div className="main-box-gen-info">
                <div className="top-section-um">
                    ...
                    <div className={`info-box-fih`}>Number of Templates: {filteredFiles.length}</div>
                        ...
                        <table className="gen-table">
                            <thead className="gen-head-del">
                                <tr>
                                    ...
                                    {renderTh("fileName", "Template Name", "gen-th ibraGenDelFN")}
...
export default FTSDeletedTemplatesSO;