...
const FTSDeletedTemplateDraftsPage = () => {
    ...
    const pageConfig = useMemo(() => {
        const configMap = {
            template: {
                ...
                titleField: `Deleted Template Drafts`,
                loadRoute: `${process.env.REACT_APP_URL}/api/ftsDrafts/templates/deletedDrafts/${userID}`,
                deleteRoute: (draftId) => `${process.env.REACT_APP_URL}/api/ftsDrafts/templates/delete/permanent/${draftId}`,
                restoreRoute: (draftId) => `${process.env.REACT_APP_URL}/api/ftsDrafts/templates/restore/${draftId}`,
            },
...
export default FTSDeletedTemplateDraftsPage;