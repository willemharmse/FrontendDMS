...
const SuggestFTSField = ({ isOpen, onClose, setFieldData, onAdd }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const route = `/api/ftsGenerate/draft`;

            const data = { fieldName, definition };
            ...
            setLoading(false);
            setMessage({ text: "Field added successfully!", type: "success" });
            ...
            setFieldData((prevData) =>
                prevData.some((f) => f.field === newFieldData.field)
                    ? prevData
                    : [...prevData, newFieldData]
            );

            if (onAdd) onAdd(newFieldData);
        ...
        <div className="term-popup-overlay">
            <div className="term-popup-content">
                <div className="term-popup-header">
                    <h2 className="term-popup-title">Suggest New Field</h2>
...
export default SuggestFTSField;