...
const DeletedUserTable = ({
    ...
    const columns = [
        ...
        { id: "role", title: "Role" },
        { id: "deletedBy", title: "Deleted By" },
        { id: "deletedAt", title: "Deleted On" },
        { id: "permanentDeleteAt", title: "Expiry Date" },
    ...
    const getCellValue = (user, colId) => {
        switch (colId) {
            ...
            case "deletedBy":
                return user.deletedBy?.username || "";
            case "deletedAt":
                return formatDate(user.deletedAt);
            case "permanentDeleteAt":
                return formatDate(user.permanentDeleteAt);
            default:
                return "";
        }
    };
    ...
    return (
        <div className="table-flameproof-card">
            <div className="flameproof-table-header-label-wrapper">
                <label className="risk-control-label">Deleted Users</label>
            </div>
            <div className="table-container-user">
                <table>
                    <thead className='trashed'>
                        <tr>
                            {columns.map((col) => (
                                <th
                                    key={col.id}
                                            ...
                                            col.id === "username" ? "user-man-name-user" :
                                                col.id === "email" ? "user-man-email-user" :
                                                    col.id === "role" ? "user-man-role-user" :
                                                        col.id === "deletedBy" ? "user-man-day-user" :
                    ...
                    <tbody>
                        {displayedUsers.map((user, index) => (
                            <tr key={user._id}>
                                ...
                                <td className="col-um">{(user.deletedBy?.username)}</td>
                                <td className="col-um">{formatDate(user.deletedAt)}</td>
                                <td className="col-um">{formatDate(user.permanentDeleteAt)}</td>
                                <td className="col-um">
                                    <div className='inline-actions-um'>
                                        ...
                                        >
                                            <FontAwesomeIcon icon={faRotateLeft} title="Restore User" />
                                        </button>
                                        <button
                                            ...
                                            disabled={!(user._id !== loggedInUserId)}
                                        >
                                            <FontAwesomeIcon icon={faTrash} title="Permanently Delete User" />
                                        </button>
                                    </div>
                                </td>
                            </tr>
