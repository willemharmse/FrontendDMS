...
const ApprovalPopupPPE = ({ closeModal, approve, decline, suggestion, setSuggestion }) => {
    const dataObj =
        ...
        <div className="approve-suggestion-overlay">
            <div className="approve-suggestion-content">
                <div className="review-date-header">
                    <h2 className="review-date-title">Review PPE Suggestion</h2>
                    <button className="review-date-close" onClick={closeModal} title="Close Popup">×</button>
                </div>

                <div className="approve-suggestion-group">
                    <div className="approve-suggestion-text">Do you want to approve this PPE suggestion?</div>
                    <div className="approve-suggestion-group-text">
                        <div className="approve-suggestion-text">PPE</div>
...
export default ApprovalPopupPPE;