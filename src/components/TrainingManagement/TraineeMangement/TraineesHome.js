...
import { faUser, faPeopleGroup, faX, faSort, faCircleUser, faBell, faArrowLeft, faSearch, faCirclePlus, faCalculator, faTrash, faCaretLeft, faCaretRight, faBookOpen, faFileCirclePlus, faUserCircle } from '@fortawesome/free-solid-svg-icons';
import TopBar from "../../Notifications/TopBar";
import TraineesDetailTable from "./TraineesDetailTable";
        ...
        <div className="user-info-container">
            {isSidebarVisible && (
                <div className="sidebar-um">
                        ...
                        <div className="button-container-dept">
                            <button className="but-um">
                                <div className="button-content">
                                    ...
                                    <span className="button-text">New Trainee</span>
                                </div>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="sidebar-logo-dm-fi">
                        <FontAwesomeIcon icon={faUser} alt="Logo" className="logo-img-dept-view" />
                        <p className="logo-text-dm-fi">{"Manage Trainees"}</p>
                    </div>
                </div>
            )}
            ...
            <div className="main-box-user">
                <div className="top-section-um">
                    ...
                    <div className="info-box-um">Number of Trainees: {trainees.length}</div>
