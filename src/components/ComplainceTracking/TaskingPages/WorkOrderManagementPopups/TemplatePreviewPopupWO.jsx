 ...
 *  - titleSuffix: string             optional badge appended next to the "Template Preview" heading, e.g. "[Approved]"
 */
const TemplatePreviewPopupWO = ({
    onClose,
    formData,
    previewEndpoint = '/api/workOrderTasks/preview-template',
    titleSuffix = '',
}) => {
...
export default TemplatePreviewPopupWO;