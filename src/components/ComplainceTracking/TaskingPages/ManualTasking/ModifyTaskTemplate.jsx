...
const ModifyTaskTemplate = ({ onClose, onTaskAdded, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(
                `${process.env.REACT_APP_URL}/api/taskTemplates/${taskId}`,
                {
            ...
            toast.success('Task template updated successfully.', { autoClose: 2000, closeButton: false });
            onTaskAdded?.();
            onClose?.();
        } catch (error) {
            toast.error(
...
export default ModifyTaskTemplate;