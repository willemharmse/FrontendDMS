...
const ReviewPageSOBLRA = () => {
    ...
    const saveData = async (fileID) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffBLRA/save/${fileID}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const getNewAzureFileName = async () => {
        try {
            ...
            const response = await fetch(
                `${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffBLRA/getFile/${fileID}`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const autoSaveDraft = () => {
        ...
        toast.success("Published Document Saved.")
    };
    ...
    const handlePublishApprovalFlow = async (approversValue) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/riskApprovals/start-approval-blra-signedOff`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const approveDraft = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/riskApprovals/approve-signedOff-blra`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const sendUpdatedFormData = async (formDataToStore, documentName) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/riskGenerate/publish-signedOff-BLRA`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
...
export default ReviewPageSOBLRA;