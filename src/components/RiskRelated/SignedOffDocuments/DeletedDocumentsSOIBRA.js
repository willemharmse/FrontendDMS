...
const DeletedDocumentsSOIBRA = () => {
    ...
    const deleteFile = async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffIBRA/deleteFile/${fileToDelete}`, {
    ...
    const restoreFile = async (fileId) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffIBRA/restoreFile/${fileId}`, {
                method: 'POST',
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const fetchFiles = async () => {
        const route = `/api/fileGenDocs/signedOffIBRA/trash/getFiles`;
        try {
            ...
            {isSidebarVisible && (
                <div className="sidebar-um">
                    ...
                    <div className="sidebar-logo-dm-fi">
                        ...
                        <p className="logo-text-dm-fi">{"Deleted Controlled IBRAs"}</p>
                    </div>
                </div>
            )}
            ...
            <div className="main-box-gen-info">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">{"Deleted Controlled IBRAs"}</label>
                        <FontAwesomeIcon
                            icon={faFilter}
...
export default DeletedDocumentsSOIBRA;