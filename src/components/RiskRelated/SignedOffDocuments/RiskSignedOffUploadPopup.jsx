...
const RiskSignedOffUploadPopup = ({ onClose, docID, refresh, closeNavigate, type }) => {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            if (type === "ibra") {
                route = `${process.env.REACT_APP_URL}/api/riskGenerate/signOffIBRA/${docID}`
            } else if (type === "blra") {
                route = `${process.env.REACT_APP_URL}/api/riskGenerate/signOffBLRA/${docID}`
            }
            else if (type === "jra") {
                route = `${process.env.REACT_APP_URL}/api/t/signOffJRA/${docID}`
            }
...
export default RiskSignedOffUploadPopup;