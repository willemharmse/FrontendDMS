...
const JRATable = ({ formData, setFormData, isSidebarVisible }) => {
    ...
    const [mainColID, setMainColId] = useState("");
    ...
    const handleMainStepCommit = (rowIndex, value) => {
    ...
    const selectMainStepSuggestion = (suggestion) => {
        ...
        const key = `${mainIndex}-${mainColID}`;
        const input = mainStepInputRefs.current[key];
    ...
    const handleUnwantedEventCommit = (rowIndex, bodyIdx, hIdx, value) => {
    ...
    const selectUnwantedEventSuggestion = (suggestion) => {
        ...
        const key = `${row}-${body}-${idx}`;
        const input = unwantedEventRefs.current[key];
        if (input) input.value = suggestion;
    };
    ...
    const handleResponsibleCommit = (rowIndex, bodyIdx, hIdx, value) => {

        console.log("Committing main step:", value);
        updateResponsible(rowIndex, bodyIdx, hIdx, value);
    };
    ...
    const selectResponsibleSuggestion = (suggestion) => {
        ...
        const key = `${row}-${body}-${idx}`;
        const input = responsibleInputRefs.current[key];
        if (input) input.value = suggestion;
    };
    ...
    const handleSubStepCommit = (rowIndex, bodyIdx, hIdx, value) => {
    ...
    const selectSubStepSuggestion = (suggestion) => {
        ...
        const key = `${row}-${body}-${idx}`;
        const input = controlsInputRefs.current[key];
        if (input) input.value = suggestion;
    };
                                                            ...
                                                            >
                                                                <div className="main-cell-content">
                                                                    <textarea
                                                                        ...
                                                                        defaultValue={row.main}
                                                                        onBlur={e => handleMainStepCommit(rowIndex, e.target.value)}
                                                                        onInput={e => startTransition(() => handleMainStepInput(rowIndex, colId, e.target.value))}
                                                                        onFocus={() => startTransition(() => handleMainStepFocus(rowIndex, colId))}
                                                                    />
                                                                </div>
                                                                <button
                                                                    type="button"
                                                                        ...
                                                                        <div className="ibra-popup-page-select-container" key={uIdx}>
                                                                            <div className="ibra-popup-page-select-container">
                                                                                <textarea
                                                                                    ...
                                                                                    defaultValue={uObj.ue}
                                                                                    readOnly={isFirst}
                                                                                    onFocus={() => {
                                                                                        handleUnwantedEventFocus(rowIndex, bodyIdx, uIdx);
                                                                                    }}
                                                                                    onInput={e => { startTransition(() => handleUnwantedEventInput(rowIndex, bodyIdx, uIdx, e.target.value)) }}
                                                                                    onBlur={e => {
                                                                                        handleUnwantedEventCommit(rowIndex, bodyIdx, uIdx, e.target.value);
                                                                                    }}
                                                                                />
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div className="test-jra"
                                                                        ...
                                                                        ref={el => {
                                                                            ...
                                                                            if (el) {
                                                                                ...
                                                                                // On unmount: throw away any nodes no longer in the document
                                                                    ...
                                                                    >
                                                                        <div className="control-with-icons" key={colIdx}>
                                                                            <textarea
                                                                                ...
                                                                                rows={1}
                                                                                defaultValue={sObj.task}
                                                                                style={{
                                                                                    display: "block",
                                                                                    width: "100%",
                                                                                    marginBottom: "5px"
                                                                                }}
                                                                                onInput={e => startTransition(() => handleSubStepInput(rowIndex, bodyIdx, sIdx, e.target.value))}
                                                                                onBlur={e => handleSubStepCommit(rowIndex, bodyIdx, sIdx, e.target.value)}
                                                                                onFocus={() => startTransition(() => handleSubStepFocus(rowIndex, bodyIdx, sIdx))}
                                                                            />
                                                                        ...
                                                                        <div className="ibra-popup-page-select-container">
                                                                            <div className="select-wrapper" style={{ marginBottom: "5px" }}>
                                                                                ...
                                                                                <textarea
                                                                                    ...
                                                                                    rows={1}
                                                                                    defaultValue={teObj.R}
                                                                                    style={{
                                                                                        display: "block",
                                                                                        width: "100%",
                                                                                    }}

                                                                                    onInput={e => startTransition(() => handleResponsibleInput(rowIndex, bodyIdx, teIdx, e.target.value))}
                                                                                    onBlur={e => handleResponsibleCommit(rowIndex, bodyIdx, teIdx, e.target.value)}
                                                                    ...
                                                                    >
                                                                        <div className="control-with-icons" key={cIdx}>
                                                                            <textarea
                                                                                ...
                                                                                rows={1}
                                                                                defaultValue={cObj.control}
                                                                                style={{
                                                                                    display: "block",
                                                                                    marginBottom: "5px",
                                                                                    paddingRight: "35px",
                                                                                }}
                                                                                onInput={e => startTransition(() => syncHeight(`${rowIndex}-${bodyIdx}-${cIdx}`))}
                                                                                onBlur={e => {
