    ...
    const pageConfig = useMemo(() => {
        const configMap = {
            ibra: {
                ...
                titleField: `Deleted IBRA Drafts`,
                loadRoute: `${process.env.REACT_APP_URL}/api/riskDraft/ibra/deletedDrafts/${userID}`,
                deleteRoute: (draftId) => `${process.env.REACT_APP_URL}/api/riskDraft/ibra/delete/permanent/${draftId}`,
                restoreRoute: (draftId) => `${process.env.REACT_APP_URL}/api/riskDraft/ibra/restore/${draftId}`,
            },

            jra: {
                icon: `${process.env.PUBLIC_URL}/jra2.svg`,
                titleField: `Deleted JRA Drafts`,
                loadRoute: `${process.env.REACT_APP_URL}/api/riskDraft/jra/deletedDrafts/${userID}`,
                deleteRoute: (draftId) => `${process.env.REACT_APP_URL}/api/riskDraft/jra/delete/permanent/${draftId}`,
                restoreRoute: (draftId) => `${process.env.REACT_APP_URL}/api/riskDraft/jra/restore/${draftId}`,
            },

            blra: {
                icon: `${process.env.PUBLIC_URL}/blra2.svg`,
                titleField: `Deleted BLRA Drafts`,
                loadRoute: `${process.env.REACT_APP_URL}/api/riskDraft/blra/deletedDrafts/${userID}`,
                deleteRoute: (draftId) => `${process.env.REACT_APP_URL}/api/riskDraft/blra/delete/permanent/${draftId}`,
                restoreRoute: (draftId) => `${process.env.REACT_APP_URL}/api/riskDraft/blra/restore/${draftId}`,
            },
                                                ...
                                                >
                                                    ...
                                                    <td className="load-draft-delete" >
                                                        <button
                                                            ...
                                                            onClick={(e) => {
                                                                e.stopPropagation();
                                                                openRestore(item._id, item.formData.title);
                                                            }}
                                                        >
...
export default DeletedRiskDraftsPage;