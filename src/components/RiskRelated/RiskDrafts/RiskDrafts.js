...
import { faSpinner, faTrash, faCircleLeft, faPenToSquare, faRotateLeft, faArrowsRotate, faMagnifyingGlass, faCircleXmark, faX, faFilter, faSortUp, faSortDown, faArrowLeft, faCaretRight, faCaretLeft, faSearch, faEdit, faFile, fa1, faPeopleArrowsLeftRight, faUser, faArrowRight } from '@fortawesome/free-solid-svg-icons';
import TopBar from "../../Notifications/TopBar";
import TransferDraftOwnership from "./TransferDraftOwnership";
...
const RiskDrafts = () => {
    ...
    const getDraftDocuments = async () => {
        ...
        route = `${process.env.REACT_APP_URL}/api/riskDraft/all-drafts`
    ...
    return (
        <div className="gen-file-info-container">
            ...
            <div className="main-box-gen-info">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">{"Migrate RMS Drafts"}</label>
                        <FontAwesomeIcon
                            icon={faFilter}
            ...
            {batchTransfer && (<MigrateDraftOwnership onClose={closeBatch} draftType="RMS" />)}
            <ToastContainer />
        </div>
    );
};

export default RiskDrafts;