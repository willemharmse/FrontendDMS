...
const DeletedRiskDocumentsJRA = () => {
    ...
    const deleteFile = async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/jra/deleteFile/${fileToDelete}`, {
                headers: {
    ...
    const restoreFile = async (fileId) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/jra/restoreFile/${fileId}`, {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${token}`,
                }
    ...
    const fetchFiles = async () => {
        const route = `/api/fileGenDocs/jra/trash/getFiles`;
        try {
