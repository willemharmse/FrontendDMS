...
const DeletedRiskDocumentsBLRA = () => {
    ...
    const deleteFile = async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/blra/deleteFile/${fileToDelete}`, {
                headers: {
    ...
    const restoreFile = async (fileId) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/blra/restoreFile/${fileId}`, {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${token}`,
                }
    ...
    const fetchFiles = async () => {
        const route = `/api/fileGenDocs/blra/trash/getFiles`;
        try {
