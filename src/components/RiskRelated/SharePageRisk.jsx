...
import RemoveShareRisk from "./RemoveShareRisk";

const SharePageRisk = ({ userIDs, popupVisible, closePopup, setUserIDs, saveData, userID }) => {
    ...
    return (
        <div className="popup-overlay-share">
            ...
            {showConfirmation && (<RemoveShareRisk handleCancelRemoval={handleCancelRemoval} handleConfirmRemoval={handleConfirmRemoval} setRemove={setShowConfirmation} user={username} />)}
        </div>
    );
};

export default SharePageRisk;
