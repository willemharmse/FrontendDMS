...
const EditControlPopup = ({ onClose, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(
                `${process.env.REACT_APP_URL}/api/riskInfo/modify-control`,
                {
                    id: controlID,
            ...
            const msg = err?.response?.data?.error || 'Failed to modify control.';
...
export default EditControlPopup;