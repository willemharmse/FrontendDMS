            ...
            {isSidebarVisible && (
                <div className="sidebar-um">
                    ...
                    <div className="sidebar-logo-dm-fi">
                        <img src={`${process.env.PUBLIC_URL}/tmsSavedDrafts2.svg`} alt="Review & Approval Inductions" className="icon-risk-rm" />
                        <p className="logo-text-dm-fi">In Approval Visitor Inductions</p>
                    </div>
                </div>
            )}
            ...
            <div className="main-box-gen-info">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">In Approval Visitor Inductions</label>
                        <FontAwesomeIcon
                            icon={faFilter}
...
export default InductionApprovalsPage;
