...
const PublishedInductionPreviewPage = ({ draftID, closeModal }) => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                const res = await fetch(`${process.env.REACT_APP_URL}/api/visitorDrafts/getCourseDataPreviewPublished/${draftID}`, {
                    headers: {
...
export default PublishedInductionPreviewPage;
