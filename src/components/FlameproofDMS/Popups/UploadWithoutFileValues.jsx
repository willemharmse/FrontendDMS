const UploadWithoutFileValues = ({ closeModal, submit }) => {
    return (
        <div className="delete-popup-overlay">
            <div className="delete-popup-content">
                ...
                <div className="delete-file-group">
                    <div className="delete-file-text" style={{ marginBottom: "0px", paddingLeft: "5px", paddingRight: "5px" }}>{`Are you sure you want to a add Certification Body without entering some of the mandatory fields?`}</div>
                </div>
...
export default UploadWithoutFileValues;