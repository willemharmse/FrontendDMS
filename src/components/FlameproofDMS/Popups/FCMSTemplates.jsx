...
const FCMSTemplates = ({ onClose }) => {
    ...
    const downloadTemplateCert = () => {
        ...
        link.href = `${process.env.PUBLIC_URL}/TAU5 - Flameproof Certificate List V0.4 (05.09.2025).xlsx`; // Adjust path as needed
        link.setAttribute('download', 'TAU5 - Flameproof Certificate List V0.4 (05.09.2025).xlsx');
        ...
        <div className="import-si-popup-overlay">
            <div className="import-si-popup-content" style={{ minHeight: "0" }}>
                ...
                <div className="import-si-file-group" style={{ position: "relative" }}>
                    ...
                    <div className="import-si-value">V0.02</div>
                    <div className="import-si-label">Date Uploaded</div>
                    <div className="import-si-value">2025-09-04</div>
                </div>
                ...
                <div className="import-si-file-group" style={{ position: "relative" }}>
                    ...
                    <div className="import-si-label">Version</div>
                    <div className="import-si-value">V0.01</div>
                    <div className="import-si-label">Date Uploaded</div>
                    <div className="import-si-value">2025-09-04</div>
                </div>
            </div>
