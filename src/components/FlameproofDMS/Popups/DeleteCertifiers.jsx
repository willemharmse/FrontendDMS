...
const DeleteCertifiers = ({ closeModal, deleteFile, selectedFileName, loading, deleteFromTrash, isTrashView }) => {
    return (
        <div className="delete-popup-overlay">
            <div className="delete-popup-content">
                ...
                <div className="delete-file-group">
                    <div className="delete-file-text">{isTrashView ? "Are you sure you want to delete this certification body from trash?" : "Are you sure you want to delete this certification body?"}{ }</div>
                    <div>{selectedFileName}</div>
                </div>

                <div className="delete-file-buttons">
                    {isTrashView ?
                        <button className="delete-file-button-delete" onClick={deleteFromTrash} disabled={loading}>
