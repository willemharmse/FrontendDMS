...
const BatchRegisterComponentsWarehouse = ({ onClose }) => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_URL}/api/flameWarehouse/importComponents`, formData, {
                headers: {
        ...
        <div className="batch-popup-overlay">
            <div className="batch-popup-content">
                <div className="batch-file-header">
                    <h2 className="batch-file-title">Register Multiple Components</h2>
                    <button className="batch-file-close" onClick={onClose} title="Close Popup">×</button>
                </div>

                <div className="batch-file-group">
                    <div className="batch-file-text">Upload Component List</div>
                ...
                <div className="batch-file-group-table">
                    <div className="batch-file-text">Upload Component Certicates</div>
                    <div className="batch-file-buttons">
...
export default BatchRegisterComponentsWarehouse;