...
const SGIBackupHistory = () => {
    ...
    const columns = [
        ...
        { id: "createdAtBackup", title: "Date Created" },
        { id: "expiresAt", title: "Expiry Date" },
    ...
    const getCellValue = (row, colId) => {
        switch (colId) {
            ...
            case "createdAtBackup":
                return formatDate(row.createdAtBackup);
            case "expiresAt":
            ...
            <div className="main-box-version-history-file">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">SGI Backups</label>
                    </div>
