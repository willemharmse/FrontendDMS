    ...
    const pageConfig = useMemo(() => {
        const configMap = {
            procedure: {
                ...
                titleField: `Deleted Procedure Drafts`,
                loadRoute: `${process.env.REACT_APP_URL}/api/draft/deletedDrafts/${userID}`,
                deleteRoute: (draftId) => `${process.env.REACT_APP_URL}/api/draft/delete/permanent/${draftId}`,
                restoreRoute: (draftId) => `${process.env.REACT_APP_URL}/api/draft/restore/${draftId}`,
            },

            standard: {
                icon: `${process.env.PUBLIC_URL}/standardsDMSInverted.svg`,
                titleField: `Deleted Standard Drafts`,
                loadRoute: `${process.env.REACT_APP_URL}/api/draft/standards/deletedDrafts/${userID}`,
                deleteRoute: (draftId) => `${process.env.REACT_APP_URL}/api/draft/standards/delete/permanent/${draftId}`,
            ...
            special: {
                ...
                deleteRoute: (draftId) => `${process.env.REACT_APP_URL}/api/draft/special/delete/permanent/${draftId}`,
                restoreRoute: (draftId) => `${process.env.REACT_APP_URL}/api/draft/special/restore/${draftId}`,
            },
...
export default DeletedDMSDraftsPage;