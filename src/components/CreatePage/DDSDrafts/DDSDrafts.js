...
import { faSpinner, faTrash, faCircleLeft, faPenToSquare, faRotateLeft, faArrowsRotate, faMagnifyingGlass, faCircleXmark, faX, faFilter, faSortUp, faSortDown, faArrowLeft, faCaretRight, faCaretLeft, faSearch, faEdit, faFile, faUser, faArrowRight } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="main-box-gen-info">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">{"Migrate DDS Drafts"}</label>
                        <FontAwesomeIcon
                            icon={faFilter}
