...
import { faFloppyDisk, faCheckCircle, faSpinner, faRotateLeft, faArrowLeft, faBell, faCircleUser, faChevronLeft, faChevronRight, faCaretLeft, faCaretRight, faRotateRight, faSave, faPen, faUpload } from '@fortawesome/free-solid-svg-icons';
...
import PPETable from "../PPETable";
import HandToolTable from "../HandToolsTable";
...
const ReviewPageSOProcedure = () => {
    ...
    const getNewAzureFileName = async () => {
        try {
            ...
            const response = await fetch(
                `${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffProcedure/getFile/${fileID}`,
                {
                    method: "GET",
                    headers: {
    ...
    const saveData = async (fileID) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffProcedure/save/${fileID}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const handlePublishApprovalFlow = async (approversValue) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/documentApprovals/start-approval-proc-signedOff`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const approveDraft = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/documentApprovals/approve-signedOff-proc`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const sendUpdatedFormData = async (dataToStore, documentName) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/docCreate/publish-signedOff`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`
...
export default ReviewPageSOProcedure;