...
import { faFloppyDisk, faCheckCircle, faSpinner, faRotateLeft, faMagicWandSparkles, faArrowLeft, faBell, faCircleUser, faChevronLeft, faChevronRight, faCaretLeft, faCaretRight, faRotateRight, faSave, faPen, faUpload } from '@fortawesome/free-solid-svg-icons';
...
const ReviewPageSOStandard = () => {
    ...
    const saveData = async (fileID) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffStandard/save/${fileID}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const getNewAzureFileName = async () => {
        try {
            ...
            const response = await fetch(
                `${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffStandard/getFile/${fileID}`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePublishApprovalFlow = async (approversValue) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/documentApprovals/start-approval-stand-signedOff`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const approveDraft = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/documentApprovals/approve-signedOff-stand`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const sendUpdatedFormData = async (dataToStore, documentName) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/docCreate/publish-signedOff-standard`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`
...
export default ReviewPageSOStandard;