...
import { faFloppyDisk, faCheckCircle, faCalendarDays, faX, faSpinner, faRotateLeft, faMagicWandSparkles, faArrowLeft, faBell, faCircleUser, faChevronLeft, faChevronRight, faCaretLeft, faCaretRight, faRotateRight, faSave, faPen, faUpload } from '@fortawesome/free-solid-svg-icons';
...
import DocumentSignaturesTableSI from "../DocumentSignaturesTableSI";
import SpecialInstructionsTable from "../SpecialInstructionsTable";
import AbbreviationTableSI from "../AbbreviationTableSI";
import TermTableSI from "../TermTableSI";
import ReferenceTableSpecialInstructions from "../ReferenceTableSpecialInstructions";
import DatePicker from "react-multi-date-picker";
import ApproversPopup from "../../VisitorsInduction/InductionCreation/ApproversPopup";

const ReviewPageSOSpecial = () => {
    ...
    const saveData = async (fileID) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffSpecial/save/${fileID}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    const getNewAzureFileName = async () => {
        try {
            ...
            const response = await fetch(
                `${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffSpecial/getFile/${fileID}`,
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handlePublishApprovalFlow = async (approversValue) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/documentApprovals/start-approval-special-signedOff`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const approveDraft = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/documentApprovals/approve-signedOff-special`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
    ...
    const sendUpdatedFormData = async (dataToStore, documentName) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/docCreate/publish-signedOff-specialIns`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("token")}`
...
export default ReviewPageSOSpecial;