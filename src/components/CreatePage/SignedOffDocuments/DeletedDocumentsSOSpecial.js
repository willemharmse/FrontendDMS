...
const DeletedDocumentsSOSpecial = () => {
    ...
    const deleteFile = async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffSpecial/deleteFile/${fileToDelete}`, {
    ...
    const restoreFile = async (fileId) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/signedOffSpecial/restoreFile/${fileId}`, {
                method: 'POST',
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const fetchFiles = async () => {
        const route = `/api/fileGenDocs/signedOffSpecial/trash/getFiles`;
        try {
            ...
            {isSidebarVisible && (
                <div className="sidebar-um">
                    ...
                    <div className="sidebar-logo-dm-fi">
                        ...
                        <p className="logo-text-dm-fi">{"Deleted Controlled Special Instructions"}</p>
                    </div>
                </div>
            )}
            ...
            <div className="main-box-gen-info">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">{"Deleted Controlled Special Instructions"}</label>
                        <FontAwesomeIcon
                            icon={faFilter}
...
export default DeletedDocumentsSOSpecial;