        ...
        <div className="dc-info-container">
            {isSidebarVisible && (
                <div className="sidebar-um">
                    ...
                    <div className="sidebar-logo-dm-fi">
                        <img src={`${process.env.PUBLIC_URL}/proceduresDMSInverted.svg`} className="icon-risk-rm" />
                        <p className="logo-text-dm-fi">{"Procedures"}</p>
                    </div>
                </div>
            )}
            ...
            <div className="main-box-dc">
                ...
                <div className="scrollable-box-dc-home">
                    <div className={`document-card-fi-home-all`} onClick={() => navigate("/FrontendDMS/documentCreateProc/Procedure/new")}>
                        <>
                            <div className="all-icon-fi-home">
                                <img src={`${process.env.PUBLIC_URL}/proceduresDMSInverted.svg`} className={"all-icon-fi-home"} />
                            </div>
                            <h3 className="document-title-dc-home">Develop Procedure</h3>
                        </>
                    </div>
                    <div className={`document-card-dc-home`} onClick={() => navigate("/FrontendDMS/documentDevelopmentDrafts/procedure")}>
                        <>
...
export default ProcedureHomePage;