...
const DeletedDocumentsSI = () => {
    ...
    const deleteFile = async () => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/special/deleteFile/${fileToDelete}`, {
                headers: {
    ...
    const restoreFile = async (fileId) => {
        try {
            const response = await fetch(`${process.env.REACT_APP_URL}/api/fileGenDocs/special/restoreFile/${fileId}`, {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${token}`,
                }
    ...
    const fetchFiles = async () => {
        const route = `/api/fileGenDocs/special/trash/getFiles`;
        try {
            ...
            <div className="main-box-gen-info">
                ...
                <div className="table-flameproof-card">
                    <div className="flameproof-table-header-label-wrapper">
                        <label className="risk-control-label">{"Deleted Special Instructions"}</label>
                    </div>
...
export default DeletedDocumentsSI;